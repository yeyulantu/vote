...
<head>
    ...
    <script src="<?php echo (WEB_STYLE); ?>/admin/lib/layui/layui.js" charset="utf-8"></script>
      ...
      <div id="side-nav">
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo U('users/index','','',true);?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>会员列表</cite>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo U('activities/index');?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>活动列表</cite>
                        </a>
                    </li >
			...
			<li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo U('works/index');?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>作品列表</cite>
                        </a>
                    </li >
