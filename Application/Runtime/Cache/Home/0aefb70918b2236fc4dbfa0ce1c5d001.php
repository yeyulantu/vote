			...
			<div class="activity-list" data-page="2">
				<?php if(is_array($activities)): foreach($activities as $key=>$act): ?><div class="activity-item">
					...
					<div class="activity-manage">
						<a href="<?php echo U('activities/statistics',array('aid'=>$act['id']),'',true);?>">统计</a><a href="<?php echo U('activities/add',array('aid'=>$act['id']),'',true);?>">编辑</a><a href="<?php echo U('works/index',array('aid'=>$act['id']),'',true);?>">作品/选手管理</a><a href="javascript:;" class="qrcode-img" data-param="http://www.baidu.com"><i class="glyphicon glyphicon-qrcode"></i></a>
					</div>
